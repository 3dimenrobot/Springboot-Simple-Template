<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialog" :close-on-click-modal="false" :before-close="cancel" :title="isAdd ? '新增新闻' : '编辑新闻'" append-to-body width="570px">
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="76px">
        <el-form-item label="新闻内容" prop="temperature">
...
<script>
  import {readList,create,remove} from '@/api/corn/newsItem'
